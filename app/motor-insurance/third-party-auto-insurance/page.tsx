...
export default function ThirdPartyAutoInsurance() {
  ...
  return (
    <InsurancePolicyLayout
      ...
      heroDescription="Our Third Party motor insurance covers accidental damage caused by your vehicle to another person's vehicle or property. It also covers the third party's medical expenses, if any bodily injury is sustained."
      heroImage="/images/third-party.png"
      heroImageAlt="Woman smiling in car"
      benefits={benefits}
      documents={documents}
      categories={categories}
       onGetQuote={() => {
      router.push('/motor-insurance/third-party-auto-insurance/policy');
     }}
    />
  );
}
